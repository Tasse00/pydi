...
from tests.app_dc import Restaurant, Kitchen, Cashier, EatingRoom, Staff
from tests.app_dc.seat import Seat


class TestContext(unittest.TestCase):

    xml_file: Path = Path(__file__).parent.joinpath("resources", "beans-dc.xml")
